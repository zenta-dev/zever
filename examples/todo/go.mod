module github.com/zenta-dev/zever/examples/todo
...
replace github.com/zenta-dev/zever/adapters/document/local => ../../adapters/document/local

replace github.com/zenta-dev/zever/adapters/log/slog => ../../adapters/log/slog

replace github.com/zenta-dev/zever/adapters/media/ffmpeg => ../../adapters/media/ffmpeg

replace github.com/zenta-dev/zever/adapters/media/local => ../../adapters/media/local

replace github.com/zenta-dev/zever/adapters/observability/stdout => ../../adapters/observability/stdout

replace github.com/zenta-dev/zever/adapters/permission/rbac => ../../adapters/permission/rbac
