// Command seed populates this project's database with development data.
//
// Scaffolded by `zever generate seed` (hand-written to match its shape). Run
// it against a database that `zever db migrate` has already created the
// tables in.
package main
