module github.com/zenta-dev/zever/adapters/cache/redis
...
require (
	...
	github.com/zenta-dev/zever/shared/cas v0.0.0
...
replace github.com/zenta-dev/zever/adapters/cache/memory => ../memory
